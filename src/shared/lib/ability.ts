...
export function buildAbilityFor(ctx: AbilityContext): AppAbility {
  ...
  if (orgRole === 'org:owner') {
    ...
    can('update', 'Product', PROTECTED_PRODUCT_FIELDS as unknown as string[], { organizationId: orgId })
    can('update', 'Order', PROTECTED_ORDER_FIELDS as unknown as string[], { organizationId: orgId })
    can('update', 'Member', PROTECTED_MEMBER_FIELDS as unknown as string[], { organizationId: orgId })
  }
