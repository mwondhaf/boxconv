...
export function VendorOrderStatusChart({
  ...
  const chartData = React.useMemo(
    () => [
      ...
      { status: "confirmed", orders: data.confirmed, fill: "var(--color-confirmed)" },
      { status: "processing", orders: data.processing, fill: "var(--color-processing)" },
      { status: "out_for_delivery", orders: data.out_for_delivery, fill: "var(--color-out_for_delivery)" },
      { status: "delivered", orders: data.delivered, fill: "var(--color-delivered)" },
      { status: "cancelled", orders: data.cancelled, fill: "var(--color-cancelled)" },
    ],
    [data]
  )
