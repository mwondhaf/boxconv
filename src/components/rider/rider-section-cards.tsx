import { IconTrendingDown, IconTrendingUp, IconClock, IconCash } from "@tabler/icons-react"
...
export function RiderSectionCards({ data = defaultData, isOnline = true }: RiderSectionCardsProps) {
  return (
          ...
          <CardAction>
            ...
            >
              <span className="relative flex size-2">
                ...
                <span className={`relative inline-flex size-2 rounded-full ${isOnline ? 'bg-green-500' : 'bg-gray-500'}`} />
              </span>
        ...
        <CardHeader>
          ...
          <CardAction>
            <Badge variant="outline">
              ...
              {data.completedToday.isPositive ? "+" : ""}{data.completedToday.trend}%
            </Badge>
          </CardAction>
        </CardHeader>
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
        ...
        <CardHeader>
          ...
          <CardAction>
            <Badge variant="outline">
              ...
              {data.todaysEarnings.isPositive ? "+" : ""}{data.todaysEarnings.trend}%
            </Badge>
          </CardAction>
        </CardHeader>
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <div className="line-clamp-1 flex gap-2 font-medium">
            {data.todaysEarnings.isPositive ? "Earnings up!" : "Keep delivering!"}
