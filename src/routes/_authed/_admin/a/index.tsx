        ...
        <div className="flex flex-col gap-4 px-4 sm:flex-row sm:items-center sm:justify-between lg:px-6">
          <div>
            ...
            <p className="text-muted-foreground">
              Platform overview. Manage orders, riders, vendors, and system
              settings.
            </p>
          </div>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                {[
                  ...
                  {
                    type: "rider",
                    message: "Rider Moses T. went online",
                    vendor: "",
                    time: "5 min ago",
                    status: "online",
                  },
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      >
                        {activity.type === "order" && (
                          <IconPlus className="size-4 text-blue-600 dark:text-blue-400" />
                        )}
                        {activity.type === "rider" && (
                          <IconTruck className="size-4 text-green-600 dark:text-green-400" />
                        )}
                        {activity.type === "vendor" && (
                          <IconBuildingStore className="size-4 text-purple-600 dark:text-purple-400" />
                        )}
                      </div>
                      <div>
