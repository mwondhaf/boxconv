            ...
            return (
              ...
              >
                ...
                <div className="flex flex-1 items-center gap-2">
                  <div className="flex flex-1 items-center gap-2">
                    <Label className="sr-only" htmlFor={`${key}-open`}>
                      Opening time
                    </Label>
                    <Input
                    ...
                    <Label className="sr-only" htmlFor={`${key}-close`}>
                      Closing time
                    </Label>
                    <Input
                      className="w-full sm:w-28"
                ...
                <div className="hidden items-center gap-2 sm:flex">
                  ...
                  />
                  <Label
                    className="w-14 text-muted-foreground text-sm"
 ...
 */
export function isStoreOpen(hours: BusinessHours, timezone = "UTC"): boolean {
  const now = new Date();
